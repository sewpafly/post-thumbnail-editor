...
d;c=a("#pte-loading");d=function(){c.hide();return true};a("#pte-preview").load(d);c.ajaxStart(function(){return a(this).fadeIn(200)}).ajaxStop(function(){return a(this).fadeOut(200)});o.setTimeout(d,2E3);return true};p=function(){var c;c=new y(function(){var d;log("===== REFLOW =====");e.fixThickbox(o.parent);d=a("#pte-sizes").offset();d=a(o).height()-d.top-2;a("#pte-sizes").height(d);log("WINDOW WIDTH: "+a(o).width());a("#stage2, #stage3").filter(":hidden").css({left:a(o).width()});return true},
100);a(o).resize(c.doFunc).load(c.doFunc);return true};h=function(){var c;c=function(d){d.delegate("tr","click",function(b){b.target.type!=="checkbox"&&a("input:checkbox",this).click();return true});return d.delegate("input:checkbox","click",function(){this.checked||a(this).is("input:checked")?a(this).parents("tr").first().removeClass("selected"):a(this).parents("tr").first().addClass("selected");return true})};c(a("#stage2"));return c(a("#stage1"))};x=null;v={keys:true,minWidth:3,minHeight:3,handles:true,
zIndex:1200,instance:true,onSelectEnd:function(c,d){return d.width&&d.width>0&&d.height&&d.height>0&&a(".pte-size").filter(":checked").size()>0?a("#pte-submit").removeAttr("disabled"):a("#pte-submit").attr("disabled",true)}};f=function(){return e.ias=x=a("#pte-image img").imgAreaSelect(v)};s=function(c){log("===== SETTING ASPECTRATIO: "+c+" =====");x.setOptions({aspectRatio:c});return x.update()};i=function(){var c,d;d=new y(function(){log("===== CHECK SUBMIT BUTTON =====");if(a(".pte-confirm").filter(":checked").size()>
0){log("ENABLE");a("#pte-confirm").removeAttr("disabled")}else{log("DISABLE");a("#pte-confirm").attr("disabled",true)}return true},50);c=new y(function(){var b;b=null;a("input.pte-size").filter(":checked").each(function(k,l){try{b=E(b,thumbnail_info[a(l).val()])}catch(n){b=null;b!==x.getOptions().aspectRatio&&alert(n);return false}return true});s(b);v.onSelectEnd(null,x.getSelection());return true},50);a.extend(e.functions,{pteVerifySubmitButtonHandler:d});a("input.pte-size").click(c.doFunc);return a(".pte-confirm").live("click",
function(){return d.doFunc()})};j=function(){var c;a("#pte-submit").click(function(){var d,b;b=x.getSelection();d=a("#pte-sizer").val();d={id:a("#pte-post-id").val(),action:"pte_ajax","pte-action":"resize-images","pte-sizes[]":a(".pte-size").filter(":checked").map(function(){return a(this).val()}).get(),x:Math.floor(b.x1/d),y:Math.floor(b.y1/d),w:Math.floor(b.width/d),h:Math.floor(b.height/d)};log("===== RESIZE-IMAGES =====");log(d);x.setOptions({hide:true,x1:0,y1:0,x2:0,y2:0});a("#pte-submit").attr("disabled",
true);a.getJSON(ajaxurl,d,c);return true});return c=function(d){log("===== RESIZE-IMAGES SUCCESS =====");log(d);e.parseServerLog(d.log);if(d.error!=null&&d.thumbnails==null)alert(d.error);else{a("#stage1").moveLeft();a("#stage2").html(a("#stage2template").tmpl(d)).moveLeft({callback:e.functions.pteVerifySubmitButtonHandler.doFunc});return false}}};m=function(){var c;a("#pte-confirm").live("click",function(){var d,b;b={};a("input.pte-confirm").filter(":checked").each(function(k,l){var n;n=a(l).val();
return b[n]=a("#pte-"+n+"-file").val()});d={id:a("#pte-post-id").val(),action:"pte_ajax","pte-action":"confirm-images","pte-nonce":a("#pte-nonce").val(),"pte-confirm":b};log("===== CONFIRM-IMAGES =====");log(d);return a.getJSON(ajaxurl,d,c)});return c=function(d){log("===== CONFIRM-IMAGES SUCCESS =====");log(d);e.parseServerLog(d.log);a("#stage2").moveLeft();a("#stage3").html(a("#stage3template").tmpl(d)).moveLeft();return false}};g=function(){var c,d;d=function(b){var k,l;b!=null&&b.preventDefault();
b=(k=(l=b.data)!=null?l.selector:void 0)!=null?k:".pte-size";return a(b).filter(":checked").click()};c=function(b){var k,l;b!=null&&b.preventDefault();b=(k=b!=null?(l=b.data)!=null?l.selector:void 0:void 0)!=null?k:".pte-size";return a(b).not(":checked").click()};a("#pte-selectors .all").click(c);a("#pte-selectors .none").click(d).click();a("#stage2").delegate("#pte-stage2-selectors .all","click",{selector:".pte-confirm"},c);a("#stage2").delegate("#pte-stage2-selectors .none","click",{selector:".pte-confirm"},
d);return true};return a.extend(e.functions,{iasSetAR:s})})(u)}).call(this);
