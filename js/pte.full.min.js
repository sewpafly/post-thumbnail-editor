...
a.extend({direction:"left",speed:500,easing:"swing",toggle:true,callback:null,callbackargs:null},e);this.each(function(){G.queue(I(function(g){var h,i,j;h=a(this);i=e.direction==="left"?-1:1;j=h.css("left")==="0px"?a(o).width()*i:0;if(h.is(":visible")){h.animate({left:j},e.speed,e.easing);h.hide(0,g)}else h.show(0,function(){a(this).animate({left:j},e.speed,e.easing,g);return true});return true},this));return true});e.callback!=null&&G.queue(function(g){e.callbackargs!=null?e.callback.apply(this,
e.callbackargs):e.callback.apply(this);return g()});return this},moveRight:function(e){e=a.extend(e,{direction:"right"});return this.move(e)},moveLeft:function(e){e=a.extend(e,{direction:"left"});return this.move(e)}});o.goBack=function(e){e!=null&&e.preventDefault();a("#stage2").moveRight();a("#stage1").moveRight({callback:function(){D(a("#pte-post-id").val());return a("#stage2").html("")}});return true};B=function(e,g){if(e===0)return g;for(;g>0;)if(e>g)e-=g;else g-=e;if(e<0||g<0)return null;return e};
E=function(e,g){var h,i,j,m;h=g.crop;m=g.width;j=g.height;h=+h;m=+m;j=+j;i=B(m,j);if(h!=null&&h>0){h=null;if((m!=null)>0&&(j!=null)>0)h=i!=null?""+m/i+":"+j/i:""+m+":"+j;if(e!=null&&h!=null&&h!==e)throw objectL10n.aspect_ratio_disabled;e=h}return e};u.functions={determineAspectRatio:E};(function(e){var g,h,i,j,m,q,p,s,v,x,f;e.editor=function(){p();i();f();h();j();m();g();q();return true};q=function(){var c,d;c=a("#pte-loading");d=function(){c.hide();return true};a("#pte-preview").load(d);c.ajaxStart(function(){return a(this).fadeIn(200)}).ajaxStop(function(){return a(this).fadeOut(200)});
