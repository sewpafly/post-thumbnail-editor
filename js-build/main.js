...
(function() {
  define('cs!apps/urlCacheBreaker',['angular'], function(angular) {
    var app;
...
(function() {
  define('cs!apps/pteApp',['angular', 'angular-resource', 'cs!apps/urlCacheBreaker'], function(angular) {
    var app;
...
(function() {
  ...
  define('cs!controllers/PteCtrl',['angular', 'cs!apps/pteApp', 'cs!settings', 'cs!jquery'], function(angular, app, settings, $) {
      ...
      '$scope', '$resource', '$log', '$filter', function($scope, $resource, $log, $filter) {
        ...
        */
        ...
        $scope.trashAll = function() {
          deleteTemp();
          return angular.forEach($scope.thumbnails, function(thumb) {
...
(function() {
  define('cs!jcrop-api',['cs!jquery', 'cs!settings', 'jcrop', 'domReady!'], function($, settings) {
    var crop_options, jcrop;

    jcrop = null;
    crop_options = {
      onChange: function() {
        var bgColor, changeBgColor, crop_h, crop_w, h, w, _ref, _ref1;

        _ref = this.getOptions().cropConstraints, crop_w = _ref[0], crop_h = _ref[1];
        bgColor = this.getOptions().bgColor;
        _ref1 = this.tellSelect(), w = _ref1.w, h = _ref1.h;
        jcrop = this;
        ...
        if ((crop_w && crop_w > 0 && crop_w > w) || (crop_h && crop_h > 0 && crop_h > h)) {
          changeBgColor('red');
        } else {
          changeBgColor('green');
        }
...
(function() {
  define('cs!controllers/CropCtrl',['cs!apps/pteApp', 'cs!jcrop-api', 'cs!jquery', 'cs!settings'], function(app, jcrop, $, settings) {
    app.controller("CropCtrl", [
      '$scope', '$log', function($scope, $log) {
        $scope.$watch('pteCropSave', function(x, y) {
          var update_options, updated;
        ...
        */
        ...
        $scope.updateSelected = function() {
          var allCrop, ar, crop, cropConstraints, cropH, cropW, error, height, selected, thumbnail, tmp_ar, width, _i, _len, _ref;
          ...
          try {
            ...
            for (_i = 0, _len = _ref.length; _i < _len; _i++) {
              ...
              if (thumbnail.selected) {
                cropW = cropConstraints[0], cropH = cropConstraints[1];
                if (!cropW || cropW > thumbnail.width) {
                  cropW = thumbnail.width;
                }
                if (!cropH || cropH > thumbnail.height) {
              ...
              if (crop > 0) {
                if (allCrop === null) {
                  allCrop = tmp_ar;
                } else if (allCrop > 0 && allCrop !== tmp_ar) {
                  allCrop = -1;
                }
              }
              if (thumbnail.selected && crop > 0) {
                if (ar !== null && ar !== tmp_ar) {
                  throw "PTE_EXCEPTION";
                }
                ar = tmp_ar;
              }
        ...
        */
        ...
        $scope.submitCrop = function() {
          var crop_options, crop_results, h, selected_thumbs, w, x, x2, y, y2, _ref;
...
(function() {
  define('cs!controllers/ViewCtrl',['cs!apps/pteApp'], function(app) {
...
(function() {
  define('cs!csmain',['cs!jquery', 'angular', 'cs!apps/pteApp', 'cs!controllers/PteCtrl', 'cs!controllers/TableCtrl', 'cs!controllers/CropCtrl', 'cs!controllers/ViewCtrl'], function($, angular, pteApp) {
